...
<body>
    <!-- This overlay is for the mobile menu -->
    <div class="mobile-menu-overlay" id="mobile-menu-overlay"></div>

    <!-- 
      =================
      MODERN MOBILE MENU (OFF-CANVAS)
      =================
    -->
                    ...
                    <li class="has-dropdown-mobile">
                        ...
                        <ul class="dropdown-menu-mobile">
                            @foreach ($global_categories as $category)
                                <li><a href="/product?category={{ $category->id }}">{{ $category->category_name }}</a></li>
                            @endforeach
                        </ul>
                    </li>
        ...
        <div class="header-main">
            <div class="container main-header-content">
                ...
                <div class="header-actions">
                    <div class="auth-container desktop-only">
                        @if(auth()->user())
    ...
    <footer class="site-footer">
        ...
        <div class="footer-credits">
            <p>&copy; 2024 RangilaLace - ECommerce Store. All Rights Reserved.<br>Powered by AHM Innotech</p>
        </div>
    </footer>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            document.querySelectorAll('.dropdown-toggle-mobile').forEach(toggle => {
                toggle.addEventListener('click', () => {
                    const parentLi = toggle.closest('.has-dropdown-mobile');
                    if (parentLi) {
